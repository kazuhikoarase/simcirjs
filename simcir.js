...
var simcir = function($) {
    ...
    return function(device) {
      ...
      device.createUI = function() {
        ...
        var updateUI = function() {
          ...
          transform(in1.$ui, x0, y0);
          transform(out1.$ui, x1, y1);
  ...
  registerDevice('Joint', createJointFactory() );
  // deprecated.
  registerDevice('SmallBUF', createJointFactory(), true);
